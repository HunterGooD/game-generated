...
const _RAW := {
	...
	"chain_lightning": {
		"name": "Chain Lightning", "script": "res://scripts/skills/mage/skill_chain_lightning.gd",
	...
	"frost_nova": {
		...
		"name": "Frost Nova", "script": "res://scripts/skills/mage/skill_frost_nova.gd",
		"icon": "res://assets/sprites/items/icon_skill_ice_bolt.png",
	...
	"death_beam": {
		...
		"name": "Death Beam", "script": "res://scripts/skills/mage/skill_death_beam.gd",
		"icon": "res://assets/sprites/items/icon_skill_chain_lightning.png",
	...
	"leap_slam": {
		"name": "Leap Slam", "script": "res://scripts/skills/barbarian/skill_leap_slam.gd",
	...
	"earthquake": {
		"name": "Earthquake", "script": "res://scripts/skills/barbarian/skill_earthquake.gd",
	...
	"barb_chain_hook": {
		# TODO(art): dedicated icon; reuses Leap Slam's for now.
		"name": "Chain Hook", "script": "res://scripts/skills/barbarian/skill_barb_chain_hook.gd",
		"icon": "res://assets/sprites/items/icon_barb_leap.png",
	...
	"barb_banner_block": {
		"name": "Victory Banner", "script": "res://scripts/skills/barbarian/skill_barb_banner.gd",
		"icon": "res://assets/sprites/items/icon_barb_cry.png",
	...
	"barb_worldsplitter_block": {
		"name": "Titan Strike", "script": "res://scripts/skills/barbarian/skill_barb_worldsplitter.gd",
		"icon": "res://assets/sprites/items/icon_barb_quake.png",
	...
	"storm_eye_of_storm_block": {
		"name": "Eye of the Storm", "script": "res://scripts/skills/stormcaller/skill_storm_eye_of_storm.gd",
	...
	# ROGUE
	"caltrops": {
		"name": "Caltrops", "script": "res://scripts/skills/rogue/skill_caltrops.gd",
	...
	"smoke_bomb": {
		"name": "Smoke Bomb", "script": "res://scripts/skills/rogue/skill_smoke_bomb.gd",
	...
	"druid_bite": {
		"name": "Savage Bite", "script": "res://scripts/skills/druid/skill_druid_bite.gd",
	...
	"druid_leap": {
		"name": "Hunting Leap", "script": "res://scripts/skills/druid/skill_druid_leap.gd",
	...
	"druid_sweep": {
		"name": "Sweeping Maul", "script": "res://scripts/skills/druid/skill_druid_sweep.gd",
	...
	"druid_charge": {
		"name": "Stone Charge", "script": "res://scripts/skills/druid/skill_druid_charge.gd",
	...
	"druid_stone_armor": {
		"name": "Stone Armor", "script": "res://scripts/skills/druid/skill_druid_stone_armor.gd",
	...
	"druid_summon_spirit": {
		"name": "Summon Spirit", "script": "res://scripts/skills/druid/skill_druid_summon_spirit.gd",
	...
	"druid_eagle_form": {
		"name": "Eagle Form", "script": "res://scripts/skills/druid/skill_druid_eagle_form.gd",
	...
	"druid_talon_swoop": {
		"name": "Talon Swoop", "script": "res://scripts/skills/druid/skill_druid_talon_swoop.gd",
	...
	"druid_wind_gust": {
		"name": "Wind Gust", "script": "res://scripts/skills/druid/skill_druid_wind_gust.gd",
	...
	"necro_raise_skeleton": {
		"name": "Raise Skeleton", "script": "res://scripts/skills/necromancer/skill_necro_raise_skeleton.gd",
	...
	"necro_raise_knight": {
		"name": "Raise Knight", "script": "res://scripts/skills/necromancer/skill_necro_raise_knight.gd",
	...
	"necro_blood_pact": {
		"name": "Blood Pact", "script": "res://scripts/skills/necromancer/skill_necro_blood_pact.gd",
		"icon": "res://assets/sprites/items/icon_necro_blood_pact.png",
	...
	"necro_death_pulse": {
		"name": "Death Pulse", "script": "res://scripts/skills/necromancer/skill_necro_death_pulse.gd",
	...
	"necro_curse_field": {
		"name": "Curse Field", "script": "res://scripts/skills/necromancer/skill_necro_curse_field.gd",
	...
	"druid_hurricane": {
		"name": "Hurricane", "script": "res://scripts/skills/druid/skill_druid_hurricane.gd",
	...
	"druid_dire_wolf_form": {
		"name": "Dire Wolf Form", "script": "res://scripts/skills/druid/skill_druid_dire_wolf_form.gd",
	...
	# HEXEN
	"hexen_hex_mark": {
		"name": "Hex Mark", "script": "res://scripts/skills/hexen/skill_hexen_hex_mark.gd",
	...
	"hexen_blood_whip": {
		"name": "Blood Whip", "script": "res://scripts/skills/hexen/skill_hexen_blood_whip.gd",
	...
	"hexen_soul_tether": {
		"name": "Soul Tether", "script": "res://scripts/skills/hexen/skill_hexen_soul_tether.gd",
	...
	"hexen_crimson_ritual": {
		"name": "Crimson Ritual", "script": "res://scripts/skills/hexen/skill_hexen_crimson_ritual.gd",
	...
	# STORMCALLER
	"storm_chain_bolt": {
		"name": "Chain Bolt", "script": "res://scripts/skills/stormcaller/skill_storm_chain_bolt.gd",
	...
	"storm_step": {
		"name": "Storm Step", "script": "res://scripts/skills/stormcaller/skill_storm_step.gd",
	...
	"storm_sky_strike": {
		"name": "Sky Strike", "script": "res://scripts/skills/stormcaller/skill_storm_sky_strike.gd",
		"icon": "res://assets/sprites/items/icon_storm_sky_strike.png",
	...
	"storm_static_discharge": {
		"name": "Static Discharge", "script": "res://scripts/skills/stormcaller/skill_storm_static_discharge.gd",
	...
	"flame_cleave": {
		"name": "Flame Cleave", "script": "res://scripts/skills/mage/skill_flame_cleave.gd",
		"icon": "res://assets/sprites/items/icon_skill_fire_wall.png",
	...
	"frost_guard": {
		"name": "Frost Guard", "script": "res://scripts/skills/mage/skill_frost_guard.gd",
		"icon": "res://assets/sprites/items/icon_skill_ice_bolt.png",
	...
	"falling_brand": {
		"name": "Falling Brand", "script": "res://scripts/skills/mage/skill_falling_brand.gd",
		"icon": "res://assets/sprites/items/icon_skill_meteor.png",
	...
	# Elementalist R (Mage).
	"elemental_orbit": {
		"name": "Elemental Orbit", "script": "res://scripts/skills/shared/skill_elemental_orbit.gd",
		"icon": "res://assets/sprites/items/icon_skill_chain_lightning.png",
	...
	# Chronomancer R (Mage).
	"temporal_dome": {
		"name": "Temporal Dome", "script": "res://scripts/skills/shared/skill_temporal_dome.gd",
		"icon": "res://assets/sprites/items/icon_skill_ice_bolt.png",
	...
	"time_wall": {
		"name": "Time Wall", "script": "res://scripts/skills/mage/skill_time_wall.gd",
		"icon": "res://assets/sprites/items/icon_skill_fire_wall.png",
	...
	"time_link": {
		"name": "Time Link", "script": "res://scripts/skills/mage/skill_time_link.gd",
		"icon": "res://assets/sprites/items/icon_skill_chain_lightning.png",
	...
	"barb_bloodstorm": {
		"name": "Bloodstorm", "script": "res://scripts/skills/barbarian/skill_barb_bloodstorm.gd",
		"icon": "res://assets/sprites/items/icon_barb_whirlwind.png",
	...
	"barb_skullcrack_leap": {
		"name": "Skullcrack Leap", "script": "res://scripts/skills/barbarian/skill_barb_skullcrack_leap.gd",
		"icon": "res://assets/sprites/items/icon_barb_leap.png",
		"cooldown": 9.0, "mana_cost": 22.0, "damage_mult": 1.8,
		"sfx": "res://assets/audio/sfx/player/player_spell_leap.mp3",
		"spawn": "with_caster", "behavior": "dash",
	...
	"barb_rage_howl": {
		"name": "Rage Howl", "script": "res://scripts/skills/barbarian/skill_barb_rage_howl.gd",
		"icon": "res://assets/sprites/items/icon_barb_cry.png",
	...
	"barb_banner": {
		"name": "Banner of the Ancients", "script": "res://scripts/skills/barbarian/skill_barb_banner.gd",
		"icon": "res://assets/sprites/items/icon_barb_cry.png",
	...
	"barb_guardian_leap": {
		"name": "Guardian Leap", "script": "res://scripts/skills/barbarian/skill_barb_guardian_leap.gd",
		"icon": "res://assets/sprites/items/icon_barb_leap.png",
	...
	"barb_worldsplitter": {
		"name": "Worldsplitter", "script": "res://scripts/skills/barbarian/skill_barb_worldsplitter.gd",
		"icon": "res://assets/sprites/items/icon_barb_quake.png",
	...
	"barb_stone_grinder": {
		"name": "Stone Grinder", "script": "res://scripts/skills/barbarian/skill_barb_stone_grinder.gd",
		"icon": "res://assets/sprites/items/icon_barb_whirlwind.png",
		"cooldown": 9.0, "mana_cost": 20.0, "damage_mult": 0.5,
		"sfx": "res://assets/audio/sfx/player/player_spell_whirlwind.mp3",
		"spawn": "attached_to_caster", "behavior": "melee_arc",
	...
	"barb_fault_zone": {
		"name": "Fault Zone", "script": "res://scripts/skills/barbarian/skill_barb_fault_zone.gd",
		"icon": "res://assets/sprites/items/icon_barb_quake.png",
		"cooldown": 14.0, "mana_cost": 36.0, "damage_mult": 1.6,
		"sfx": "res://assets/audio/sfx/player/player_spell_earthquake.mp3",
		"spawn": "at_caster", "behavior": "ground",
	...
	"barb_tremor_roar": {
		"name": "Tremor Roar", "script": "res://scripts/skills/barbarian/skill_barb_tremor_roar.gd",
		"icon": "res://assets/sprites/items/icon_barb_cry.png",
	...
	"rogue_deathmark_dash": {
		"name": "Deathmark Dash", "script": "res://scripts/skills/rogue/skill_rogue_deathmark_dash.gd",
		"icon": "res://assets/sprites/items/icon_rogue_knives.png",
	...
	"rogue_execution_fan": {
		"name": "Execution Fan", "script": "res://scripts/skills/rogue/skill_rogue_execution_fan.gd",
		"icon": "res://assets/sprites/items/icon_rogue_knives.png",
		"cooldown": 10.0, "mana_cost": 30.0, "damage_mult": 1.3,
		"sfx": "res://assets/audio/sfx/player/player_spell_fan_knives.mp3",
		"spawn": "at_caster", "behavior": "melee_arc",
	...
	"rogue_razor_trap": {
		"name": "Razor Trap", "script": "res://scripts/skills/rogue/skill_rogue_razor_trap.gd",
		"icon": "res://assets/sprites/items/icon_rogue_caltrops.png",
	...
	"rogue_decoy_mirage": {
		"name": "Decoy Mirage", "script": "res://scripts/skills/rogue/skill_rogue_decoy_mirage.gd",
		"icon": "res://assets/sprites/items/icon_rogue_smoke.png",
	...
	"rogue_safehouse": {
		"name": "Safehouse", "script": "res://scripts/skills/rogue/skill_rogue_safehouse.gd",
		"icon": "res://assets/sprites/items/icon_rogue_smoke.png",
		"cooldown": 12.0, "mana_cost": 20.0, "damage_mult": 1.0,
		"sfx": "res://assets/audio/sfx/player/player_spell_smoke_bomb.mp3",
		"spawn": "at_caster", "behavior": "ground",
	...
	"rogue_trick_field": {
		"name": "Trick Field", "script": "res://scripts/skills/rogue/skill_rogue_trick_field.gd",
		"icon": "res://assets/sprites/items/icon_rogue_caltrops.png",
		"cooldown": 8.0, "mana_cost": 18.0, "damage_mult": 0.3,
		"sfx": "res://assets/audio/sfx/player/player_spell_caltrops.mp3",
		"spawn": "at_target", "behavior": "ground",
	...
	"rogue_confusion_flask": {
		"name": "Confusion Flask", "script": "res://scripts/skills/rogue/skill_rogue_confusion_flask.gd",
		"icon": "res://assets/sprites/items/icon_rogue_poison.png",
	...
	"rogue_plague_bloom": {
		"name": "Plague Bloom", "script": "res://scripts/skills/rogue/skill_rogue_plague_bloom.gd",
		"icon": "res://assets/sprites/items/icon_rogue_poison.png",
	...
	"rogue_triple_flask": {
		"name": "Triple Flask", "script": "res://scripts/skills/rogue/skill_rogue_triple_flask.gd",
		"icon": "res://assets/sprites/items/icon_rogue_poison.png",
		"cooldown": 7.0, "mana_cost": 22.0, "damage_mult": 0.45,
		"sfx": "res://assets/audio/sfx/player/player_spell_poison.mp3",
		"spawn": "at_caster", "behavior": "projectile",
	...
	"rogue_venom_fan": {
		"name": "Venom Fan", "script": "res://scripts/skills/rogue/skill_rogue_venom_fan.gd",
		"icon": "res://assets/sprites/items/icon_rogue_knives.png",
		"cooldown": 10.0, "mana_cost": 30.0, "damage_mult": 1.3,
		"sfx": "res://assets/audio/sfx/player/player_spell_fan_knives.mp3",
		"spawn": "at_caster", "behavior": "melee_arc",
	...
	"rogue_toxic_spikes": {
		"name": "Toxic Spikes", "script": "res://scripts/skills/rogue/skill_rogue_toxic_spikes.gd",
		"icon": "res://assets/sprites/items/icon_rogue_caltrops.png",
		"cooldown": 8.0, "mana_cost": 18.0, "damage_mult": 0.4,
		"sfx": "res://assets/audio/sfx/player/player_spell_caltrops.mp3",
		"spawn": "at_target", "behavior": "ground",
	...
	"storm_lightning_overdrive": {
		"name": "Lightning Overdrive", "script": "res://scripts/skills/stormcaller/skill_storm_lightning_overdrive.gd",
		"icon": "res://assets/sprites/items/icon_storm_static_discharge.png",
	...
	"storm_charged_slash": {
		"name": "Charged Slash", "script": "res://scripts/skills/stormcaller/skill_storm_charged_slash.gd",
		"icon": "res://assets/sprites/items/icon_storm_chain_bolt.png",
		"cooldown": 4.0, "mana_cost": 16.0, "damage_mult": 1.4,
		"sfx": "res://assets/audio/sfx/player/player_storm_chain_bolt.mp3",
		"spawn": "at_caster", "behavior": "melee_arc",
	...
	"storm_forked_bolt": {
		"name": "Forked Bolt", "script": "res://scripts/skills/stormcaller/skill_storm_forked_bolt.gd",
		"icon": "res://assets/sprites/items/icon_storm_chain_bolt.png",
		"cooldown": 4.0, "mana_cost": 16.0, "damage_mult": 1.4,
		"sfx": "res://assets/audio/sfx/player/player_storm_chain_bolt.mp3",
		"spawn": "at_caster", "behavior": "chain",
	...
	"storm_living_battery": {
		"name": "Living Battery", "script": "res://scripts/skills/stormcaller/skill_storm_living_battery.gd",
		"icon": "res://assets/sprites/items/icon_storm_chain_bolt.png",
	...
	"storm_rescue_step": {
		"name": "Rescue Step", "script": "res://scripts/skills/stormcaller/skill_storm_rescue_step.gd",
		"icon": "res://assets/sprites/items/icon_storm_step.png",
	...
	"storm_energizing_discharge": {
		"name": "Energizing Discharge", "script": "res://scripts/skills/stormcaller/skill_storm_energizing_discharge.gd",
		"icon": "res://assets/sprites/items/icon_storm_static_discharge.png",
		"cooldown": 16.0, "mana_cost": 22.0, "damage_mult": 1.6,
		"sfx": "res://assets/audio/sfx/player/player_storm_static_discharge.mp3",
		"spawn": "at_caster", "behavior": "aoe",
	...
	"storm_ally_arc": {
		"name": "Ally Arc", "script": "res://scripts/skills/stormcaller/skill_storm_ally_arc.gd",
		"icon": "res://assets/sprites/items/icon_storm_chain_bolt.png",
		"cooldown": 4.0, "mana_cost": 16.0, "damage_mult": 1.4,
		"sfx": "res://assets/audio/sfx/player/player_storm_chain_bolt.mp3",
		"spawn": "at_caster", "behavior": "chain",
	...
	"hexen_scarlet_possession": {
		"name": "Scarlet Possession", "script": "res://scripts/skills/hexen/skill_hexen_scarlet_possession.gd",
		"icon": "res://assets/sprites/items/icon_hexen_blood_whip.png",
		"cooldown": 65.0, "mana_cost": 40.0, "damage_mult": 1.0,
		"sfx": "res://assets/audio/sfx/player/player_hexen_blood_whip.mp3",
		"spawn": "at_caster", "behavior": "buff",
	...
	"hexen_blood_scythe": {
		"name": "Blood Scythe", "script": "res://scripts/skills/hexen/skill_hexen_blood_scythe.gd",
		"icon": "res://assets/sprites/items/icon_hexen_blood_whip.png",
		"cooldown": 5.0, "mana_cost": 18.0, "damage_mult": 1.3,
		"sfx": "res://assets/audio/sfx/player/player_hexen_blood_whip.mp3",
		"spawn": "ahead_of_caster", "behavior": "melee_arc",
	...
	"hexen_open_wound": {
		"name": "Open Wound", "script": "res://scripts/skills/hexen/skill_hexen_open_wound.gd",
		"icon": "res://assets/sprites/items/icon_hexen_hex_mark.png",
		"cooldown": 2.0, "mana_cost": 14.0, "damage_mult": 0.9,
		"sfx": "res://assets/audio/sfx/player/player_hexen_hex_mark_apply.mp3",
		"spawn": "at_target", "behavior": "mark",
	...
	"hexen_blood_arena": {
		"name": "Blood Arena", "script": "res://scripts/skills/hexen/skill_hexen_blood_arena.gd",
		"icon": "res://assets/sprites/items/icon_hexen_crimson_ritual.png",
	...
	"hexen_grand_malediction": {
		"name": "Grand Malediction", "script": "res://scripts/skills/hexen/skill_hexen_grand_malediction.gd",
		"icon": "res://assets/sprites/items/icon_hexen_hex_mark.png",
	...
	"hexen_rotating_hex": {
		"name": "Rotating Hex", "script": "res://scripts/skills/hexen/skill_hexen_rotating_hex.gd",
		"icon": "res://assets/sprites/items/icon_hexen_hex_mark.png",
		"cooldown": 2.0, "mana_cost": 14.0, "damage_mult": 0.9,
		"sfx": "res://assets/audio/sfx/player/player_hexen_hex_mark_apply.mp3",
		"spawn": "at_target", "behavior": "mark",
	...
	"hexen_curse_chain": {
		"name": "Curse Chain", "script": "res://scripts/skills/hexen/skill_hexen_curse_chain.gd",
		"icon": "res://assets/sprites/items/icon_hexen_soul_tether.png",
		"cooldown": 12.0, "mana_cost": 32.0, "damage_mult": 0.6,
		"sfx": "res://assets/audio/sfx/player/player_hexen_soul_tether.mp3",
		"spawn": "at_caster", "behavior": "chain",
	...
	"hexen_ritual_of_doom": {
		"name": "Ritual of Doom", "script": "res://scripts/skills/hexen/skill_hexen_ritual_of_doom.gd",
		"icon": "res://assets/sprites/items/icon_hexen_crimson_ritual.png",
		"cooldown": 18.0, "mana_cost": 36.0, "damage_mult": 0.4,
		"sfx": "res://assets/audio/sfx/player/player_hexen_crimson_ritual.mp3",
		"spawn": "at_target", "behavior": "ground",
	...
	"hexen_coven_pact": {
		"name": "Coven Pact", "script": "res://scripts/skills/hexen/skill_hexen_coven_pact.gd",
		"icon": "res://assets/sprites/items/icon_hexen_soul_tether.png",
	...
	"hexen_ally_tether": {
		"name": "Ally Tether", "script": "res://scripts/skills/hexen/skill_hexen_ally_tether.gd",
		"icon": "res://assets/sprites/items/icon_hexen_soul_tether.png",
		"cooldown": 12.0, "mana_cost": 32.0, "damage_mult": 0.6,
		"sfx": "res://assets/audio/sfx/player/player_hexen_soul_tether.mp3",
		"spawn": "at_caster", "behavior": "mark",
	...
	"hexen_safe_ritual": {
		"name": "Safe Ritual", "script": "res://scripts/skills/hexen/skill_hexen_safe_ritual.gd",
		"icon": "res://assets/sprites/items/icon_hexen_crimson_ritual.png",
		"cooldown": 18.0, "mana_cost": 36.0, "damage_mult": 0.4,
		"sfx": "res://assets/audio/sfx/player/player_hexen_crimson_ritual.mp3",
		"spawn": "at_caster", "behavior": "ground",
	...
	"hexen_binding_whip": {
		"name": "Binding Whip", "script": "res://scripts/skills/hexen/skill_hexen_binding_whip.gd",
		"icon": "res://assets/sprites/items/icon_hexen_blood_whip.png",
		"cooldown": 5.0, "mana_cost": 18.0, "damage_mult": 1.3,
		"sfx": "res://assets/audio/sfx/player/player_hexen_blood_whip.mp3",
		"spawn": "ahead_of_caster", "behavior": "melee_arc",
	...
	"necro_grave_champion": {
		"name": "Grave Champion", "script": "res://scripts/skills/necromancer/skill_necro_grave_champion.gd",
		"icon": "res://assets/sprites/items/icon_necro_raise_knight.png",
	...
	"necro_bone_citadel": {
		"name": "Bone Citadel", "script": "res://scripts/skills/necromancer/skill_necro_bone_citadel.gd",
		"icon": "res://assets/sprites/items/icon_necro_raise_knight.png",
	...
	"necro_bone_turret": {
		"name": "Bone Turret", "script": "res://scripts/skills/necromancer/skill_necro_bone_turret.gd",
		"icon": "res://assets/sprites/items/icon_necro_raise_skeleton.png",
	...
	"necro_bone_golem": {
		"name": "Bone Golem", "script": "res://scripts/skills/necromancer/skill_necro_bone_golem.gd",
		"icon": "res://assets/sprites/items/icon_necro_raise_knight.png",
		"cooldown": 16.0, "mana_cost": 40.0, "damage_mult": 1.2,
		"sfx": "res://assets/audio/sfx/player/player_necro_raise_knight.mp3",
		"spawn": "at_target", "behavior": "summon",
	...
	"necro_second_funeral": {
		"name": "Second Funeral", "script": "res://scripts/skills/necromancer/skill_necro_second_funeral.gd",
		"icon": "res://assets/sprites/items/icon_necro_blood_pact.png",
	...
	"necro_blood_ward": {
		"name": "Blood Ward", "script": "res://scripts/skills/necromancer/skill_necro_blood_ward.gd",
		"icon": "res://assets/sprites/items/icon_necro_blood_pact.png",
		"cooldown": 18.0, "mana_cost": 0.0, "damage_mult": 1.0,
		"sfx": "res://assets/audio/sfx/player/player_necro_blood_pact.mp3",
		"spawn": "at_caster", "behavior": "buff",
	...
	"necro_mending_pulse": {
		"name": "Mending Pulse", "script": "res://scripts/skills/necromancer/skill_necro_mending_pulse.gd",
		"icon": "res://assets/sprites/items/icon_necro_death_pulse.png",
	...
	"necro_oathbound_knight": {
		"name": "Oathbound Knight", "script": "res://scripts/skills/necromancer/skill_necro_oathbound_knight.gd",
		"icon": "res://assets/sprites/items/icon_necro_raise_knight.png",
	...
	"druid_living_grove": {
		"name": "Living Grove", "script": "res://scripts/skills/druid/skill_druid_living_grove.gd",
		"icon": "res://assets/sprites/items/icon_druid_summon_spirit.png",
	...
	"druid_guardian_spirit": {
		"name": "Guardian Spirit", "script": "res://scripts/skills/druid/skill_druid_guardian_spirit.gd",
		"icon": "res://assets/sprites/items/icon_druid_summon_spirit.png",
		"cooldown": 22.0, "mana_cost": 38.0, "damage_mult": 1.0,
		"sfx": "res://assets/audio/sfx/player/player_druid_summon_spirit.mp3",
		"spawn": "at_caster", "behavior": "summon",
	...
	"druid_tempest_communion": {
		"name": "Tempest Communion", "script": "res://scripts/skills/druid/skill_druid_tempest_communion.gd",
		"icon": "res://assets/sprites/items/icon_druid_eagle_form.png",
	...
	"druid_storm_totem": {
		"name": "Storm Totem", "script": "res://scripts/skills/druid/skill_druid_storm_totem.gd",
		"icon": "res://assets/sprites/items/icon_druid_summon_spirit.png",
		"cooldown": 22.0, "mana_cost": 38.0, "damage_mult": 1.0,
		"sfx": "res://assets/audio/sfx/player/player_druid_summon_spirit.mp3",
		"spawn": "at_caster", "behavior": "summon",
	...
	"druid_earthen_pulse": {
		"name": "Earthen Pulse", "script": "res://scripts/skills/druid/skill_druid_earthen_pulse.gd",
		"icon": "res://assets/sprites/items/icon_druid_stone_armor.png",
